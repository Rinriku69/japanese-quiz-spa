...
export default function QuizContainer({ quizes }: { quizes: MultipleChoicesQuiz[] }) {
    ...
    return (
        <div className="flex flex-col p-4 border-4 border-red-300 ">
            <h2 className="text-xl font-bold align-center">
                Qustion {currentQuiz.questionNumber}: {currentQuiz.questionText}
            </h2>

            <div className=" mt-4 border-3 border-blue-300 grid grid-cols-2">
            ...
            <div className="mt-6 flex justify-between">
                ...
                <span>{currentIndex + 1} / {quizes.length}</span>
